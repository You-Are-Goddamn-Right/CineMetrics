...
const AlertDialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "yfixed yinset-0 yz-50 ybg-black/80 data-[state=open]:yanimate-in data-[state=closed]:yanimate-out data-[state=closed]:yfade-out-0 data-[state=open]:yfade-in-0",
      className
    )}
    {...props}
    ref={ref} />
...
const AlertDialogHeader = ({
  ...
  <div
    className={cn("yflex yflex-col yspace-y-2 ytext-center sm:ytext-left", className)}
    {...props} />
)
...
const AlertDialogTitle = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn("ytext-lg yfont-semibold", className)} {...props} />
))
...
const AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn(buttonVariants({ variant: "outline" }), "ymt-2 sm:ymt-0", className)}
    {...props} />
))
