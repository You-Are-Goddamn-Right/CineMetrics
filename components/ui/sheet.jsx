  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
      ...
      <SheetPrimitive.Close
        className="yabsolute yright-4 ytop-4 yrounded-sm yopacity-70 yring-offset-background ytransition-opacity hover:yopacity-100 focus:youtline-none focus:yring-2 focus:yring-ring focus:yring-offset-2 disabled:ypointer-events-none data-[state=open]:ybg-secondary">
